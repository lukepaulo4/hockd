...
//CREATING THIS BECASUE WE KNOW THE USER WILL WANT TO CROP THEIR IMAGE INTO A SQUARE. TO AVOID REPEATING LOTS OF LAYOUT CODE IN TWO PLACES, LET'S MOVE THE 3X3 GRID OF WHITE'BORDERED SQUARES INTO A NEW CLASS.
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //Set to NO since this view doesn't handle any touch events
