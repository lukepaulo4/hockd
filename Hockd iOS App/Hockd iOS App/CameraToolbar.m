...
//Use these two views to customize the appearance of the view.
...
//Now we add the view to the view hierarchy. We add targets for the buttons. We have a default image name (camera) for the camera button, the other two images will be passed in.
...
- (void) createConstraints {
    NSDictionary *viewDictionary = NSDictionaryOfVariableBindings(_leftButton, _rightButton, _whiteView, _purpleView);
...
//Make a layoutSubviews, and round the top corners of the purple view with a mask layer
- (void) layoutSubviews {
